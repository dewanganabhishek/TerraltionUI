    ...
    function getCityList(obj) {
        ...
        apigClient.airportListPost(params, body, additionalParams)
            .then(function (result) {
                ...
                for (var i = 0; i < result.data.Airports.length; i++) {
                    htmlResult = htmlResult + "<tr>";
                    htmlResult = htmlResult + "<td class='sorting_1'>" + result.data.Airports[i].ContinentId + "</td>";
                    htmlResult = htmlResult + "<td class='title-width'>" + result.data.Airports[i].ContinentName + '</td>';
                    //htmlResult = htmlResult + '<td>' + result.data[i].StateTitle + '</td>';
                    //htmlResult = htmlResult + '<td>' + result.data[i].CountryTitle + '</td>';

                    if (!result.data.Airports[i].IsActive) {
                    ...
                    if (!result.data.Airports[i].IsPublished) {
