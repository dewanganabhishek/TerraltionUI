...
$(document).ready(function () {
    ...
    function getCityList(obj) {
        ...
        apigClient.countryListPost(params, body, additionalParams)
            .then(function (result) {
                ...
                for (var i = 0; i < result.data.Countries.length; i++) {
                    ...
                    htmlResult = htmlResult + "<td class='sorting_1'>" + result.data.Countries[i].CountryId + "</td>";
                    htmlResult = htmlResult + "<td class='title-width'>" + result.data.Countries[i].CountryName + '</td>';
                    htmlResult = htmlResult + '<td>' + result.data.Countries[i].ISOCode + '</td>';
                    //htmlResult = htmlResult + '<td>' + result.data[i].CountryTitle + '</td>';

                    if (!result.data.Countries[i].IsActive) {
                    ...
                    if (!result.data.Countries[i].IsPublished) {
