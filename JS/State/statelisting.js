...
$(document).ready(function () {
    ...
    function getCityList(obj) {
        ...
        apigClient.stateListPost(params, body, additionalParams)
            .then(function (result) {
                ...
                for (var i = 0; i < result.data.States.length; i++) {
                    ...
                    htmlResult = htmlResult + "<td class='sorting_1'>" + result.data.States[i].StateId + "</td>";
                    htmlResult = htmlResult + "<td class='title-width'>" + result.data.States[i].StateName + '</td>';
                    htmlResult = htmlResult + '<td>' + result.data.States[i].Code + '</td>';

                    if (!result.data.States[i].IsActive) {
                    ...
                    if (!result.data.States[i].IsPublished) {
